...
<head>
    ...
    <title>readprojecttopics - Admin</title>
...
<body>
    ...
    <!-- Browser Navigation Loader - Shows favicon spinner during navigation -->
    <script src="{{ asset('js/minimal-browser-loader.js') }}" defer></script>

...
use Themes\Airdgereaders\Http\ViewComposers\SubmitPageComposer;
...
class ThemeServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        // NEW: Submit page composer (combined upload + publish form)
        View::creator('resource.create.submit', SubmitPageComposer::class);

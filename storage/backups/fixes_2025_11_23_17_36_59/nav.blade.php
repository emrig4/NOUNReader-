<nav id="menu" class="menu navbar navbar-default">
    <ul class="level-1 navbar-nav">
        <li class="active"><a href="/">Home</a></li>
                <li class="active"><a href="https://projectandmaterials.com/pricings">Buy credit</a></li>
        <li><a href="#">ABOUT</a><span class="has-subnav"><i class="fa fa-angle-down"></i></span>
            <ul class="sub-menu level-2">
                <li><a href="https://projectandmaterials.com/about-us">About us</a></li>
                ...
                <li><a href="https://projectandmaterials.com/privacy-policy">privacy policy</a></li>
            </ul>
        </li>
        ...
        <li><a href="#">Research</a><span class="has-subnav"><i class="fa fa-angle-down"></i></span>
            <ul class="sub-menu level-2">
                ...
                <li><a href="https://projectandmaterials.com/project-topics-materials">Browse projects</a></li>
                ...
                <li><a href="https://projectandmaterials.com/resources/types/thesis">thesis/dissertation</a></li>
         ...
         <li>
            @if(auth()->user())
                ...
                <ul class="sub-menu level-2">
                    ...
                    <li><a href="https://projectandmaterials.com/account/my-wallet">Wallet</a></li>
                    <li><a href="https://projectandmaterials.com/account/subscription">subscription</a></li>

...
<head>
    ...
    <title>{{ $subject }}</title>
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f7fa; }
        ...
        .message-content { background-color: #f8fafc; border-radius: 8px; padding: 25px; margin: 25px 0; border-left: 4px solid; }
        ...
        .personal-note { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 1px solid #f59e0b; border-radius: 8px; padding: 15px; margin: 20px 0; text-align: center; }
        .cta-section { background-color: #eff6ff; border-radius: 12px; padding: 25px; margin: 30px 0; text-align: center; }
        .cta-section h3 { color: #1e40af; margin-bottom: 15px; }
        .footer { background-color: #1f2937; color: white; padding: 30px; text-align: center; }
        .signature { margin-top: 20px; font-style: italic; color: #6b7280; }
        @media (max-width: 600px) { body { padding: 10px; } .content { padding: 20px; } .header { padding: 30px 20px; } .title { font-size: 24px; } }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            @if($type === 'wish')
                <div style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: 8px; padding: 20px; text-align: center; margin: 20px 0;">
                    <p style="margin: 0; color: #065f46; font-weight: 600;">🎊 Thank you for being part of our community! 🎊</p>
                </div>
            @endif
